...
INSERT INTO `doctors` (`id`, `name`, `section`, `email`, `date_of_birth`, `phone_number`) VALUES
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `address`, `phone_number`, `date_of_birth`, `gender`, `email`, `password`, `user_type`) VALUES
...
--
ALTER TABLE `doctors`
  ADD CONSTRAINT `doctors_ibfk_1` FOREIGN KEY (`section`) REFERENCES `clinic_sections` (`id`) ON DELETE CASCADE;
